...
%dpy.NumShiftPeaks = 77; %must be odd number
...
theFreq=[1, 10]; %the frequencies to test for each experiment ID, can be one or more (e.g. [2,4,8])
...
dpy.NumTrialsPerLevel = 1; %the number of trials for each level
% used to be 15
