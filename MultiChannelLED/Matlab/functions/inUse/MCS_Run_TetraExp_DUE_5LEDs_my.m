...
switch dpy.ExptID
    ...
    case {'LMS'}
        if dpy.NumSpec==4
            ...
            stim.stimLMS.maxCont= .8;  
            stim.stimLMS.maxTestLevel = .8;
...
for thisTrial = 1:length(dpy.allStimTrialLevels)
    ...
    if exit==0
        [response,dpy]=MCS_tetra_led_doLEDTrial_5LEDs_my(dpy,stim,s); % This should return 0 for an incorrect answer and 1 for correct
